...
use everything_core::{
    EngineStatus, QueryRequest, SearchPage, SearchResult, SortColumn, SortDirection,
};
...
impl EverythingSdk {
    ...
    #[expect(
        ...
        reason = "the linear symbol table keeps the audited DLL contract visible in one place"
    )]
...
#[cfg(test)]
mod tests {
    use super::{filetime_to_unix, map_sort, sort_columns, PROPERTY_ID_NAME};
    use everything_core::{SortColumn, SortDirection};

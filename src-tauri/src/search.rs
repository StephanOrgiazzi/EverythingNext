...
use everything_core::{EngineStatus, QueryRequest, SearchPage, SelectionRequest};
use everything_engine::EverythingEngine;
use std::sync::{
...
impl SearchState {
    pub(crate) fn initialize<R: tauri::Runtime>(app: &tauri::App<R>) -> Self {
        ...
        let result = bundled_dll
            .as_deref()
            .map_or_else(EverythingEngine::new, EverythingEngine::from_dll_path);
